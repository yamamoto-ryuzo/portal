...
7. **[市民参加型SNS意見集約・AI提案システム構想](./7.SNS_AI_Opinion.md)**
    - 行政ダッシュボードを前提に、市民がSNS（位置情報付き）で意見を発信し、AIが課題抽出・解決策を提案、意見集約・施策反映を実現する構想（7.SNS_AI_Opinion.md）。
...
SNS_AI.md（SNS・AI連携による地域情報活用）
  ...
  ↓  
8.市民の声がひらく渋谷の未来.md（市民の声がひらく渋谷の未来提案）
7.SNS_AI_Opinion.md（市民参加型SNS意見集約・AI提案システム構想）
