...
7. [蓄積・保管層（タスクチーム作業環境）](#7-タスクチーム作業環境)
8. [付録](#8-付録)
...
| 第1層 | 蓄積・保管層（業務データ基盤） | SSOT保管・RAG基盤 | 文書・図面・BIM/IFC・点群等をSSOTで保管し、RAG向けのインデクシング・ベクトルDB・メタデータ管理を備え、AIチャットボットや要約・生成支援を支える基盤を提供する。 |
