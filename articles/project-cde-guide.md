...
![プロジェクトCDEの定義と全体構造](https://raw.githubusercontent.com/yamamoto-ryuzo/portal/refs/heads/main/プロジェクトCDE/images/01_プロジェクトCDEの定義と全体構造.png)
...
![業務データ基盤（ストレージ選定](https://yamamoto-ryuzo.github.io/portal/プロジェクトCDE\images\02_業務データ基盤（ストレージ選定）.png)
