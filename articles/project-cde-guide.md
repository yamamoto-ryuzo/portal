...
7. [AI活用層（事業監理・AI支援）](#7-ai活用層事業監理ai支援)
8. [公開・ガバナンス層（SSOT共有・公開）](#8-公開ガバナンス層ssot共有公開)
9. [付録](#9-付録)
...
| 第4層 | AI活用層（事業監理・AI支援） | 予測・要約・意思決定支援 | 進捗管理・資料整理・可視化に加え、AIによる予測分析・自動要約・意思決定支援（アラート、モデル推論、NLP要約等）を提供する。 |
...
**第4層：AI活用層（事業監理・AI支援）**
: 目的: 第1〜3層のデータを用い、予測・要約・検索・意思決定支援を提供する（RAG含む）。
- 主な機能: 予測分析、要約・レポート生成、インテリジェント検索(RAG)、異常検知、ワークフロー自動化。
- 推奨構成: 埋め込み→ベクトルDB→レトリーバ→LLM（プロンプトテンプレート）＋出典管理・応答品質評価。
...
## 8.1 CDEの決済フロー（WIP → Shared → Published / Archived）
