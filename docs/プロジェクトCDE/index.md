...
```
┌─────────────────────────────────────────────────────────────┐
│ 第5層【目的・公開層】   SSOTによる共有・公開                      │
│   → 承認済みデータを関係機関・市民・行政へ確実に届ける              │
├─────────────────────────────────────────────────────────────┤
│ 第4層【管理・監理層】   事業監理業務                             │
│   → 進捗管理・資料整理・可視化・報告、意思決定支援                 │
├─────────────────────────────────────────────────────────────┤
│ 第3層【高度化層】      デジタルツイン活用層                       │
│   → BIM/IFC × 点群 × IoT統合・リアルタイム同期・シミュレーション   │
├─────────────────────────────────────────────────────────────┤
│ 第2層【統合・可視化層】  GIS基盤・空間データ可視化基盤               │
│   → 空間データ管理・配信・2D/3D可視化（GIS本来の役割）             │
├─────────────────────────────────────────────────────────────┤
│ 第1層【蓄積・保管層】   業務データ基盤（ストレージ）                 │
│   → 文書・図面・BIM/IFC・点群・台帳の保管・権限管理（SSOT構成）     │
└─────────────────────────────────────────────────────────────┘
```
...
| 〃 | 〃 | 〃 | 〃 | 🏗️ **デジタルツインPF** | `KOLC+`（建設BIM/CIM DT → **5.5**） |
...
> **デジタルツインプラットフォーム代表事例: 建設BIM/CIM DT「KOLC+」は本章 5.5 に、スマートシティ都市DT「Re:Earth」は本章 5.6 に、XRデジタルツイン「torinome」は本章 5.4 に記載する。**
